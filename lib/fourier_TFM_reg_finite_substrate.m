function [stress_vec, pos_corrected, pos, strain_vec, grid_mat,fnorm] = fourier_TFM_reg_finite_substrate(filterart,bild_datei,strain,frames,E,s, depth, pix_durch_my, cluster_size, filter_param, cutoff )
